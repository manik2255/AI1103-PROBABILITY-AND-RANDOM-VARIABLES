...
Let A and b be two events such that $\pr{B}=\frac{3}{4}$ and $\pr{A\cup B^c}=\frac{1}{2}$.If A and B are independent, then $\pr{A}$ equals

\section{SOLUTION}
Given,
\begin{align}
\pr{B}=\frac{3}{4}\label{a}\\
\pr{A\cup B^c} =\frac{1}{2} \label{b}
\end{align}
we know that,
\begin{align}
\pr{B^c} = 1-\pr{B} \label{c}
\end{align}
using \eqref{a} in \eqref{c},
\begin{align}
\pr{B^c} = \frac{1}{4} \label{d}
\end{align}
we know that,
\begin{align}
\pr{A\cup B^c} = \pr{A} +\pr{B^c} - \pr{A\cap B^c}
\end{align}
A and B are independent $\iff$ A and $B^c$ are independent
\begin{align}
\pr{A\cup B^c} = \pr{A} +\pr{B^c} - \pr{A}\pr{B^c} \label{e}
\end{align}
